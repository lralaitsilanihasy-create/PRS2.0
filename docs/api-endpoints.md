...
> L'inscription **ne crée aucune affectation** `t_prmp_entite` : la PRMP ne peut saisir de dossier
> qu'après affectation d'au moins une entité contractante par l'Administrateur (voir **Entités-PRMP**).

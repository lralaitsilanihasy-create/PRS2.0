...
public class ReportService {
    ...
    /**
     * Rapport des dossiers traités, optionnellement borné par une période (sur DATE_REF).
     *
     * @return le PDF sous forme de tableau d'octets
     */
    public byte[] rapportDossiers(LocalDate debut, LocalDate fin) {
        List<Dossier> dossiers = (debut != null && fin != null)
        ...
        try {
            ...
            for (String entete : new String[] { "Référence", "Date", "Type", "Statut" }) {
     ...
     */
    public byte[] rapportDossiersExcel(LocalDate debut, LocalDate fin) {
        List<Dossier> dossiers = (debut != null && fin != null)
                ? dossierRepository.findByDateRefBetween(debut, fin)
                : dossierRepository.findAll();
        ...
        try (Workbook workbook = new XSSFWorkbook(); ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
            ...
            String[] entetes = { "Référence", "Date", "Type", "Statut" };
